...
export default function Reward() {
  ...
  const cChild = (
    <div className="p-24px text-[#fff]">
      ...
      <p>
        5. As an invitation reward, there are a total of 1035 Seed airdrops, and
        if the ranking does not reach 500 people, Seeds that have not been
        airdropped will be permanently destroyed by entering a black hole
        address at the end of the airdrop.
      </p>
    </div>
  );
  return (
